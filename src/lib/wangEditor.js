...
Panel.prototype = {
  ...
  show: function show() {
    ...
    $container.css('width', width + 'px').css('margin-left', '-26px')
...
Image.prototype = {
  ...
  _createInsertPanel: function _createInsertPanel() {
    ...
    var linkMaterialId = getRandom('link-material')
    ...
    var tabsConfig = [
      ...
      {
        title: '从图片库选择',
        tpl: '<div class="w-e-up-img-container">\n <div id="' + linkMaterialId + '" class="w-e-up-btn">\n<i class="el-icon-plus"></i>\n</div>\n<div style="display:none;">\n </div>\n </div>',
        events: [{
          selector: '#' + linkMaterialId,
          type: 'click',
          fn: function fn() {
            if (editor.customConfig.onAddMaterialClick) {
    ...
    if ((config.uploadImgShowBase64 || config.uploadImgServer || config.customUploadImg) && window.FileReader) {
      // 显示“上传图片”
      tabsConfigResult.push(tabsConfig[0], tabsConfig[2])
    }
